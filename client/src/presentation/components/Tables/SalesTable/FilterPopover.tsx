...
export const FilterPopover = ({
    ...
    couponValue: boolean | undefined;
    setCouponValue: React.Dispatch<React.SetStateAction<boolean | undefined>>;
    purchaseValue: string | undefined;
    setPurchaseValue: React.Dispatch<React.SetStateAction<string | undefined>>;
