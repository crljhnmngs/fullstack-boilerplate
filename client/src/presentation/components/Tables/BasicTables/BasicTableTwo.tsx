                        ...
                        {tableRowData.map((row: TableRowData) => (
                            <TableRow key={row.id}>
                                ...
                                <TableCell className="px-4 sm:px-6 py-3.5">
                                    {row.actions.delete && (
                                        <button>
                                            <IoTrashOutline className="text-gray-700 cursor-pointer size-5 hover:text-error-500 dark:text-gray-400 dark:hover:text-error-500" />
                                        </button>
                                    )}
                                </TableCell>
                            </TableRow>
