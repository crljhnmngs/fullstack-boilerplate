...
const Calendar = () => {
    ...
    const formatDateLocal = (date: Date | undefined | null): string =>
        date
    ...
    const handleEventClick = (clickInfo: EventClickArg) => {
        ...
        setEventStartDate(event.start ? formatDateLocal(event.start) : '');
        setEventEndDate(event.end ? formatDateLocal(event.end) : '');
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <span className="relative">
                                                            ...
                                                            />
                                                            <span
                                                                className={`flex items-center justify-center w-5 h-5 mr-2 border rounded-full box ${
                                                                    eventLevel ===
                                                                    key
                                                                        ? 'border-5 border-blue-500 dark:border-blue-400'
